...
public class User {
    ...
    public static final String LOCKED_OUT_COLUMN_NAME = "lockedOut";
    ...
    @DatabaseField(columnName = SALT_COLUMN_NAME)
    private String salt;

    @DatabaseField(columnName = LOCKED_OUT_COLUMN_NAME)
    private boolean isLokedOut;
