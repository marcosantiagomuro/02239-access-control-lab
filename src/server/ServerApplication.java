...
import remoteInterface.IServerApplication;
...
public class ServerApplication implements IServerApplication {
	...
	public void startPrinterServer(String printerServerName) {
		try {
			...
			String name = StringUtils.isEmpty(printerServerName) || StringUtils.isBlank(printerServerName) ? "genericPrinterServerName" : printerServerName;
